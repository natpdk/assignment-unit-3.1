...
let favoriteFoods = [ 'Ramen', 'Ice Cream', 'Salmon', 'Lemon Meringue Pie', 'Sushi' ]
...
let dessert = 'Milkshake'
favoriteFoods.push( dessert );
console.log( 'Adding a dessert to the end: ', favoriteFoods );
